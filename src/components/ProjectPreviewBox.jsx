import { KeyboardArrowLeft, KeyboardArrowRight, Close as CloseIcon, VideoLibrary, Collections, FilterNone } from '@mui/icons-material';
import { AppBar, Button, Divider, MobileStepper, Paper, Stack, Toolbar, Typography, useTheme } from '@mui/material';
    ...
    <Box onClick={focusOnNavInput}>
      ...
      >
        ...
        <Typography variant='body2' paragraph>
          <span>Platform: <strong>{project.platform}</strong> | </span>
          <span>Technology: <strong>{project.tech}</strong> | </span>
          <span>Responsibility: <strong>{project.responsibility}</strong></span>
        </Typography>
